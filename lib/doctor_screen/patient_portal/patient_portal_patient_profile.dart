...
void main() {
  runApp(const patient_portal_patient_profile());
}
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const patient_portal_patients()),
            );
          },
        ),
        title: const Text(
              ...
              children: [
                _buildGradientButton(context, 'History', onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const patient_portal_patient_profile_history()),
                  );
                }),
                const SizedBox(height: 20),
                _buildGradientButton(context, 'Write Prescription',
                    onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
