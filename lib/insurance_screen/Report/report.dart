      ...
      BarChartData(
        ...
        barGroups: [
          BarChartGroupData(x: 0, barRods: [
            BarChartRodData(toY: data.monthlySpending[0] / 1000, gradient: LinearGradient(colors: [Colors.greenAccent, Colors.teal]), width: 18, borderRadius: BorderRadius.circular(6)),
          ]),
          BarChartGroupData(x: 1, barRods: [
            BarChartRodData(toY: data.monthlySpending[1] / 1000, gradient: LinearGradient(colors: [Colors.redAccent, Colors.deepOrangeAccent]), width: 18, borderRadius: BorderRadius.circular(6)),
          ]),
        ],
        borderData: FlBorderData(show: false),
        gridData: FlGridData(show: false),
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text("Doctor Analysis", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            SizedBox(height: 10),
            ...
            SizedBox(height: 10),
            Text("Recommendation:", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.redAccent)),
            SizedBox(height: 5),
            Text(data.doctorRecommendation, style: TextStyle(fontSize: 16)),
          ],
        ),
      ),
    );
