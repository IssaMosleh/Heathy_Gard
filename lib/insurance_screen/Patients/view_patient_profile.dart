...
class PatientInsurance extends StatefulWidget {
  const PatientInsurance({Key? key}) : super(key: key);

  @override
  State<PatientInsurance> createState() => _PatientInsuranceState();
}

class _PatientInsuranceState extends State<PatientInsurance> {
          ...
          child: AppBar(
            ...
            leading: IconButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => PatientsInsurance(insuranceName: 'HealthFirst',)),
                );
              },
              ...
              buildContainer(
                child: Column(
                  ...
                  children: [
                    ...
                    const Divider(),
                    infoRow("Primary Care Physician", primaryCarePhysician),
                    infoRow("Emergency Contact", emergencyContact),
                  ],
                ),
              ),
            ],
