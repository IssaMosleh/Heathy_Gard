...
class InsuranceCompanyDetails extends StatelessWidget {
  const InsuranceCompanyDetails({super.key});
...
class _InsuranceDetailScreenState extends State<InsuranceDetailScreen> {
  ...
  List<String> affiliatedHospitals = ["Jordan Hospital", "Amman Medical Center"];
  ...
  void initState() {
    super.initState();
    nameController.text = insuranceName;
  }
      ...
      setState(() {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
         ...
         Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const InsuranceCompanySearchScreen(),
                          ),
                        );
      });
    }
