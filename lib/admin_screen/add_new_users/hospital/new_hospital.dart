...
class new_hospital extends StatelessWidget {
  const new_hospital({Key? key}) : super(key: key);
  ...
  void saveChanges() {
    if (_formKey.currentState!.validate()) {
      setState(() {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => add_new_main()),
        );
      });
    }
  }
                    ...
                    children: [
                      ...
                      Center(
                        child: ElevatedButton(
                          ...
                          child: const Text("Add Insurance Company"),
                        ),
                      ),
                      const SizedBox(height: 16),
...
class AddInsuranceDialog extends StatelessWidget {
  ...
  AddInsuranceDialog({required this.predefinedCompanies});
