...
class _DoctorSearchScreenState extends State<DoctorSearchScreen_delete> {
  List<Doctor> doctors = [
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            // List of doctor cards with delete option
            Expanded(
                      ...
                      trailing: IconButton(
                        ...
                        onPressed: () {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(content: Text('${doctor.name} has been deleted')),
                          );
                        },
                      ),
                    ),
