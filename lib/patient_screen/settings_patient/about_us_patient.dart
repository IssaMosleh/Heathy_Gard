...
class about_us_patient extends StatelessWidget {
  const about_us_patient({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        margin: const EdgeInsets.all(16.0), // Margin for padding around the container
